...
<head>
    ...
    <!-- Styles -->
    <link href="{{ asset('css/app.css') }}?v=as" rel="stylesheet">
</head>
<body>
    <div id="header">
            ...
            <div class="container m-auto">
              <div class="relative flex items-center justify-between h-16">
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                  <!-- Mobile menu button-->
                  <button type="button" class="inline-flex items-center justify-center p-2 text-gray-900 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                  <div class="flex items-center flex-shrink-0 ">
                    <span class="font-bold text-blue-600">Mami</span><span class="italic text-blue-400">Shop</span>
                  </div>
                  <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                      <a href="#" class="px-3 py-2 text-sm font-medium text-blue-500 hover:bg-blue-500 hover:text-white" aria-current="page">Home</a>
                      <a href="#" class="px-3 py-2 text-sm font-medium text-blue-500 hover:bg-blue-500 hover:text-white">BukaToko</a>
                    </div>
                  </div>
                </div>
